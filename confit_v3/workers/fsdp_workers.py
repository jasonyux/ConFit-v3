...
# from verl.utils.fsdp_utils import offload_fsdp_optimizer, offload_fsdp_model_to_cpu, load_fsdp_model_to_gpu
...
class ESActorRolloutRefWorker(Worker):
    """
    customized actor copied from verl.workers.fsdp_workers
    main modifications here include:
    - generate_sequences
    """
    ...
    def generate_sequences(self, prompts: DataProto):
        # TODO: override this
        # if you already fixed generation prompt in prompts, you may not even need to touch this class
        print(f"generate_sequences received {len(prompts)=}, {prompts.meta_info=}")
        ...
        print(f"generate_sequences output {type(output)=}, {output=}")
