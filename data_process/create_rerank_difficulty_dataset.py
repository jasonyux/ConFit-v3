    ...
    for job_id, job_rankings in job_data.items():
        ...
        for pos_resume in positives:
            for _ in range(samples_per_positive):
                ...
                rerank_prompt, was_truncated = create_rerank_prompt(
...
def save_dataset(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "split": split_name,
        "description": (
            "Rerank dataset with per-positive random negative sampling. "
...
def create_rerank_difficulty_dataset(
    ...
    *,
    ...
    """Create rerank dataset with optional difficulty annotations."""
...
def main() -> None:
    ...
    create_rerank_difficulty_dataset(
